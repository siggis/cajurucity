...
+ function(e) {
    ...
    t.DEFAULTS = {
        ...
        var t = "disabled", i = this.$element, n = i.is("input") ? "val": "html", s = i.data();
...
+ function(e) {
    ...
    t.DEFAULTS = {
        ...
        var n = this.$element.find(".item.active"), s = i || n[t](), r = this.interval, a = "next" == t ? "left": "right", o = "next" == t ? "first": "last", l = this;
        if (!s.length) {
    ...
    e.fn.carousel = function(i) {
        return this.each(function() {
            var n = e(this), s = n.data("bs.carousel"), r = e.extend({}, t.DEFAULTS, n.data(), "object" == typeof i && i), a = "string" == typeof i ? i: r.slide;
        ...
        var i, n = e(this), s = e(n.attr("data-target") || (i = n.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, "")), r = e.extend({}, s.data(), n.data()), a = n.attr("data-slide-to");
...
+ function(e) {
    ...
    t.DEFAULTS = {
        ...
        if (!this.transitioning && this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(t), !t.isDefaultPrevented()
                ...
                return e.support.transition ? (this.$element[i](0).one(e.support.transition.end, e.proxy(n, this)).emulateTransitionEnd(350), void 0) : n.call(this)
            }
        }
    }, t.prototype.toggle = function() {
    ...
    e.fn.collapse = function(i) {
        ...
        var i, n = e(this), s = n.attr("data-target") || t.preventDefault() || (i = n.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, ""), r = e(s), a = r.data("bs.collapse"), o = a ? "toggle": n.data(), l = n.attr("data-parent"), c = l && e(l);
...
+ function(e) {
    ...
    r.prototype.toggle = function(n) {
        ...
        if (!s.is(".disabled, :disabled")) {
            var r = i(s), a = r.hasClass("open");
            if (t(), !a) {
                if ("ontouchstart"in document.documentElement&&!r.closest(".navbar-nav").length && e('<div class="dropdown-backdrop"/>').insertAfter(e(this)).on("click", t), r.trigger(n = e.Event("show.bs.dropdown")
        ...
        if (/(38|40|27)/.test(t.keyCode)) {
            ...
            if (t.preventDefault(), t.stopPropagation()
                ...
                if (!a || a && 27 == t.keyCode)
                    return 27 == t.which && r.find(s).focus(), n.click();
...
+ function(e) {
    ...
    e.fn.modal = function(i, n) {
        return this.each(function() {
            var s = e(this), r = s.data("bs.modal"), a = e.extend({}, t.DEFAULTS, s.data(), "object" == typeof i && i);
            r || s.data("bs.modal", r = new t(this, a)), "string" == typeof i ? r[i](n) : a.show && r.show(n)
        })
    }, e.fn.modal.Constructor = t, e.fn.modal.noConflict = function() {
        return e.fn.modal = i, this
    }, e(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(t) {
        var i = e(this), n = i.attr("href"), s = e(i.attr("data-target") || n && n.replace(/.*(?=#[^\s]+$)/, "")), r = s.data("modal") ? "toggle": e.extend({
            remote: !/#/.test(n) && n
        }, s.data(), i.data());
...
+ function(e) {
    ...
    t.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var n = "function" == typeof this.options.placement ? this.options.placement.call(this, i[0], this.$element[0]): this.options.placement, s = /\s?auto?\s?/i, r = s.test(n);
            ...
            if (r) {
                var c = this.$element.parent(), d = n, u = document.documentElement.scrollTop || document.body.scrollTop, p = "body" == this.options.container ? window.innerWidth: c.outerWidth(), h = "body" == this.options.container ? window.innerHeight: c.outerHeight(), m = "body" == this.options.container ? 0: c.offset().left;
                n = "bottom" == n && a.top + a.height + l - u > h ? "top" : "top" == n && a.top - u - l < 0 ? "bottom" : "right" == n && a.right + o > p ? "left" : "left" == n && a.left - o < m ? "right" : n, i.removeClass(d).addClass(n)
            }
            var f = this.getCalculatedOffset(n, a, o, l);
            this.applyPlacement(f, n), this.$element.trigger("shown.bs." + this.type)
        }
    }, t.prototype.applyPlacement = function(e, t) {
        var i, n = this.tip(), s = n[0].offsetWidth, r = n[0].offsetHeight, a = parseInt(n.css("margin-top"), 10), o = parseInt(n.css("margin-left"), 10);
...
+ function(e) {
    ...
    function t(i, n) {
        ...
        this.$element = e(i).is("body") ? e(window) : e(i), this.$body = e("body"), this.$scrollElement = this.$element.on("scroll.bs.scroll-spy.data-api", r), this.options = e.extend({}, t.DEFAULTS, n), this.selector = (this.options.target || (s = e(i).attr("href")) && s.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a", this.offsets = e([]), this.targets = e([]), this.activeTarget = null, this.refresh(), this.process()
    }
    t.DEFAULTS = {
        offset: 10
        ...
        this.$body.find(this.selector).map(function() {
            var n = e(this), s = n.data("target") || n.attr("href"), r = /^#\w/.test(s) && e(s);
            return r && r.length && [[r[t]().top + (!e.isWindow(i.$scrollElement.get(0)) && i.$scrollElement.scrollTop()), s]] || null
        }).sort(function(e, t) {
            return e[0] - t[0]
        }).each(function() {
        ...
        var e, t = this.$scrollElement.scrollTop() + this.options.offset, i = this.$scrollElement[0].scrollHeight || this.$body[0].scrollHeight, n = i - this.$scrollElement.height(), s = this.offsets, r = this.targets, a = this.activeTarget;
        if (t >= n)
            return a != (e = r.last()[0]) && this.activate(e);
        for (e = s.length; e--;)
            a != r[e] && t >= s[e] && (!s[e + 1] || t <= s[e + 1]) && this.activate(r[e])
...
+ function(e) {
    ...
    t.prototype.show = function() {
        ...
        if (n || (n = t.attr("href"), n = n && n.replace(/.*(?=#[^\s]*$)/, ""))
        ...
        var r = i.find("> .active"), a = n && e.support.transition && r.hasClass("fade");
...
+ function(e) {
    ...
    t.RESET = "affix affix-top affix-bottom", t.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            var i = e(document).height(), n = this.$window.scrollTop(), s = this.$element.offset(), r = this.options.offset, a = r.top, o = r.bottom;
